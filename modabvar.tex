...
\begin{algorithm}{Decomposition of modular Jacobians}
    ...
    Let $J=J(N)$ with Hecke algebra $\T$. This algorithm will give a sequence
...
respect to a theta-divisor associated to a Riemannian form $H$.  Let $A=(V, J)$
be a subvariety of $J$. Poincare Reducibility states that the orthogonal

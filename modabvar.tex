...
\begin{algorithm}{Decomposition of modular Jacobians}
    ...
    \begin{enumerate}
        \item{} [Compute new modular symbols space]
            For each divisor $L_i$, compute the new cuspidal modular symbol
            space $\mathbb{S}_2(L_i)_\mathrm{new}$ using the techniques in
            \cite[\S 8]{stein:modform}.
...
Let $\T=\ZZ[T_1,T_2,\ldots]$ be the Hecke algebra.

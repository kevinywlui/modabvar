...
\ker\Phi_L$. We say $(L, N)$ satisfies the $\star$-condition if
$\ker\Phi_L=\Sigma(L)_0 ^r$. This condition occurs often and the check is part of
the split jacobian package. Sufficient conditions are also given in the

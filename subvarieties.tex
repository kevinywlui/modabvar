...
\]
Since degeneracy maps agree on the Shimura subgroup, $\Sigma(L)_0 ^r \subseteq
\Phi_L$. We say $(L, N)$ satisifies the $\star$-condition if
...
\end{question}
Stein, Watkins proves that this is true for Neumann-Setzer Elliptic Curves.
